...
function App() {
  return (
    <div className="App">
      ...
      {/* <Tweet tweetProp={tweetsArray[0]} test={"Ragnar"} /> */}
      {/* this is how to loop over an array in JSX ... this was the bonus for fun*/}
      {tweetsArray.map((currentTweet, index) => {
        //never forget the return inside the .map!!!!
        return <Tweet key={index} tweetProp={currentTweet} />;
      })}
    </div>
  );
}
